  ...
  var x = function () {
    ...
    return r(t, [{
      ...
      value: function (t, e) {
        ...
        for (t = Math.round(Math.abs(t) * a),
          e = Math.round(Math.abs(e) * a); e;) {
          var s = e;
          e = t % e,
            t = s
        }
    ...
    , v = function () {
      ...
      return r(t, [{
        ...
        value: function (t, e) {
          ...
          if (t.unfilter(!0),
            x.isIE() && "radialBar" === d.config.chart.type)
            return t;
          if ((null === (i = d.config.chart.dropShadow.enabledOnSeries) || void 0 === i ? void 0 : i.length) > 0 && -1 === (null === (a = d.config.chart.dropShadow.enabledOnSeries) || void 0 === a ? void 0 : a.indexOf(s)))
            return t;
          return l = Array.isArray(l) ? l[s] : l,
            t.filter((function (t) {
              var e = null;
              e = x.isSafari() || x.isFirefox() || x.isIE() ? t.flood(l, h).composite(t.sourceAlpha, "in").offset(o, r).gaussianBlur(n) : t.flood(l, h).composite(t.sourceAlpha, "in").offset(o, r).gaussianBlur(n).merge(t.source),
                t.blend(t.source, e)
            }
            )),
    ...
    , m = function () {
      ...
      return r(t, [{
        ...
        value: function (t) {
          ...
          var y = r;
          o || (o = "start"),
            c && c.length || (c = m.config.chart.foreColor),
            l = l || m.config.chart.fontFamily,
            h = h || "regular";
          var w, k = {
            maxWidth: g,
            fontSize: n = n || "11px",
          ...
          return Array.isArray(r) ? w = m.globals.dom.Paper.text((function (t) {
            for (var a = 0; a < r.length; a++)
              y = r[a],
                g && (y = i.getTextBasedOnMaxWidth(e({
                  text: r[a]
                }, k))),
                0 === a ? t.tspan(y) : t.tspan(y).newLine()
          }
          )) : (g && (y = this.getTextBasedOnMaxWidth(e({
            text: r
          }, k))),
            w = x ? m.globals.dom.Paper.plain(r) : m.globals.dom.Paper.text((function (t) {
              return t.tspan(y)
            }
            ))),
            w.attr({
        ...
        value: function (t, e, i, a) {
          var s = i / 2
            , r = this.drawLine(t, e - s, t, e + s, a.pointStrokeColor, a.pointStrokeDashArray, a.pointStrokeWidth, a.pointStrokeLineCap)
            , o = this.drawLine(t - s, e, t + s, e, a.pointStrokeColor, a.pointStrokeDashArray, a.pointStrokeWidth, a.pointStrokeLineCap);
          return this.createGroupWithAttributes(t, e, [r, o], a)
        }
      }, {
        key: "drawX",
        value: function (t, e, i, a) {
          var s = i / 2
            , r = this.drawLine(t - s, e - s, t + s, e + s, a.pointStrokeColor, a.pointStrokeDashArray, a.pointStrokeWidth, a.pointStrokeLineCap)
            , o = this.drawLine(t - s, e + s, t + s, e - s, a.pointStrokeColor, a.pointStrokeDashArray, a.pointStrokeWidth, a.pointStrokeLineCap);
          return this.createGroupWithAttributes(t, e, [r, o], a)
        }
      }, {
        key: "drawMarker",
      ...
      return r(t, [{
        ...
        value: function () {
          ...
          if (r.yRange = [],
            ...
            r.yRange.push(Math.abs(r.minY - r.maxY));
          r.xRange = Math.abs(r.maxX - r.minX),
            r.zRange = Math.abs(r.maxZ - r.minZ);
          for (var g = 0; g < r.yRange.length; g++)
            o.push(r.yRange[g] / r.gridHeight);
          if (e = r.xRange / r.gridWidth,
            t = r.yRange / r.gridWidth,
            i = r.xRange / r.gridHeight,
            (n = r.zRange / r.gridHeight * 16) || (n = 1),
            r.minY !== Number.MIN_VALUE && 0 !== Math.abs(r.minY) && (r.hasNegs = !0),
            ...
            if (r.isMultipleYAxis) {
              ...
              for (var p = 0; p < o.length; p++)
                l.push(u(r.minYArr[p], p))
            } else
              (l = []).push(u(r.minY, 0)),
                r.minY !== Number.MIN_VALUE && 0 !== Math.abs(r.minY) && (h = -r.minY / t,
                  c = r.minX / e)
          } else
            (l = []).push(0),
              h = 0,
            ...
            a.logYRange = a.yRange.map((function (t, s) {
              ...
              if (i.config.yaxis[r] && e.w.config.yaxis[r].logarithmic) {
                ...
                return a.seriesLog.forEach((function (t, e) {
                  ...
                  o = Math.pow(a.yRange[s], Math.abs(l - n) / a.yRange[s]),
        ...
        value: function (t, e) {
          var i = !1
            , a = 0
            , s = 0;
          return void 0 === e && (e = "line"),
            t.length && void 0 !== t[0].type && t.forEach((function (t) {
              "bar" !== t.type && "column" !== t.type && "candlestick" !== t.type && "boxPlot" !== t.type || a++,
        ...
        value: function (t, e, i) {
          var a, s, r, o, n, l;
          (null !== (a = e) && void 0 !== a && a.yaxis && (e = t.extendYAxis(e, i)),
            null !== (s = e) && void 0 !== s && s.annotations) && (e.annotations.yaxis && (e = t.extendYAxisAnnotations(e)),
              null !== (r = e) && void 0 !== r && null !== (o = r.annotations) && void 0 !== o && o.xaxis && (e = t.extendXAxisAnnotations(e)),
              null !== (n = e) && void 0 !== n && null !== (l = n.annotations) && void 0 !== l && l.points && (e = t.extendPointAnnotations(e)));
          return e
        }
      }]),
        t
      ...
      return r(t, [{
        ...
        value: function (t, e) {
          ...
          if (this.annoCtx.invertAxis) {
            ...
            var n = o.indexOf(a)
              , l = r.globals.dom.baseEl.querySelector(".apexcharts-yaxis-texts-g text:nth-child(" + (n + 1) + ")");
            i = l ? parseFloat(l.getAttribute("y")) : (r.globals.gridHeight / o.length - 1) * (n + 1) - r.globals.barHeight,
              void 0 !== e.seriesIndex && r.globals.barHeight && (i = i - r.globals.barHeight / 2 * (r.globals.series.length - 1) + r.globals.barHeight * e.seriesIndex)
          } else {
            var h, c = r.globals.seriesYAxisMap[e.yAxisIndex][0];
            if (r.config.yaxis[e.yAxisIndex].logarithmic)
              h = (a = new y(this.annoCtx.ctx).getLogVal(r.config.yaxis[e.yAxisIndex].logBase, a, c)) / r.globals.yLogRatio[c];
            else
              h = (a - r.globals.minYArr[c]) / (r.globals.yRange[c] / r.globals.gridHeight);
            h > r.globals.gridHeight ? (h = r.globals.gridHeight,
              s = !0) : h < 0 && (h = 0,
                s = !0),
              i = r.globals.gridHeight - h,
              !e.marker || void 0 !== e.y && null !== e.y || (i = 0),
              r.config.yaxis[e.yAxisIndex] && r.config.yaxis[e.yAxisIndex].reversed && (i = h)
          }
        ...
        value: function (t, e) {
          ...
          return i = this.annoCtx.inversedReversedAxis ? (o - a) / (n / s.globals.gridWidth) : (a - r) / (n / s.globals.gridWidth),
            "category" !== s.config.xaxis.type && !s.config.xaxis.convertedCatToNumeric || this.annoCtx.invertAxis || s.globals.dataFormatXNumeric || s.config.chart.sparkline.enabled || (i = this.getStringX(a)),
            "string" == typeof a && a.indexOf("px") > -1 && (i = parseFloat(a)),
            null == a && e.marker && (i = s.globals.gridWidth),
            void 0 !== e.seriesIndex && s.globals.barWidth && !this.annoCtx.invertAxis && (i = i - s.globals.barWidth / 2 * (s.globals.series.length - 1) + s.globals.barWidth * e.seriesIndex),
            i > s.globals.gridWidth ? (i = s.globals.gridWidth,
              l = !0) : i < 0 && (i = 0,
                l = !0),
          {
            x: i,
          ...
          if (x.isNumber(o)) {
            ...
            if (!n || !l) {
              var f = this.annoCtx.graphics.getTextRects(h, parseFloat(t.label.style.fontSize))
                , b = "top" === t.label.position ? 4 : "center" === t.label.position ? s.globals.gridHeight / 2 + ("vertical" === t.label.orientation ? f.width / 2 : 0) : s.globals.gridHeight
        ...
        value: function (t, e, i) {
          ...
          if (x.isNumber(t))
            if (0 !== a.globals.yValueDecimal)
              t = t.toFixed(void 0 !== e.decimalsInFloat ? e.decimalsInFloat : a.globals.yValueDecimal);
            else {
              var s = t.toFixed(0);
              t = t == s ? s : t.toFixed(1)
            }
    ...
    , L = function () {
      function t(e) {
        a(this, t),
          ...
          this.annoCtx = e,
          this.helpers = new w(this.annoCtx),
          this.axesUtils = new C(this.annoCtx)
      }
      return r(t, [{
        ...
        value: function (t, e, i) {
          ...
          if (null === t.y2 || void 0 === t.y2) {
            ...
            if (a = (o = this.helpers.getY1Y2("y2", t)).yP,
              h = o.clipped,
              a > n) {
              var u = n;
              n = a,
        ...
        value: function () {
          ...
          return e.config.annotations.yaxis.forEach((function (a, s) {
            e.globals.seriesYAxisMap[a.yAxisIndex][0],
              t.axesUtils.isYAxisHidden(a.yAxisIndex) || t.addYaxisAnnotation(a, i.node, s)
          }
          )),
            i
        }
          ...
          if (x.isNumber(s) && !n && !r) {
            ...
            if (d.attr({
              ...
              g.attr({
                ...
                g.node.innerHTML = t.customSVG.SVG,
                e.appendChild(g.node)
            }
            if (t.image.path) {
            ...
            t.mouseEnter && h.node.addEventListener("mouseenter", t.mouseEnter.bind(this, t)),
              t.mouseLeave && h.node.addEventListener("mouseleave", t.mouseLeave.bind(this, t)),
  ...
  var M = {
    ...
    , z = function (t) {
      ...
      ("function" == typeof p && (g = p(g, f)),
        ...
        i) || "datetime" === l.config.xaxis.type && (d = new S(a).xLabelFormat(l.globals.ttKeyFormatter, d, d, {
          i: void 0,
            ...
            for (var g = 0; g < l.x.length; g++) {
              ...
              if ("line" !== o.config.chart.type && "area" !== o.config.chart.type || o.globals.comboCharts || o.config.tooltip.intersect || (p += " no-pointer-events"),
                ...
                o.config.series[n].data[u] && (o.config.series[n].data[u].fillColor && (f.pointFillColor = o.config.series[n].data[u].fillColor),
                  ...
                  a && (f.pSize = a),
                  (l.x[g] < 0 || l.x[g] > o.globals.gridWidth || l.y[g] < -o.globals.markers.largestSize || l.y[g] > o.globals.gridHeight + o.globals.markers.largestSize) && (f.pSize = 0),
      ...
      return r(t, [{
        ...
        value: function (t) {
          var e = this
            ...
            , p = r
            , f = null;
          if (-1 !== h.globals.collapsedSeriesIndices.indexOf(s) || !d.enabled || !Array.isArray(a.x))
            return f;
          f = c.group({
            ...
            if (g = a.x[x] + d.offsetX,
              ...
              if ("bubble" === h.config.chart.type)
                v = y(b = h.globals.seriesZ[s][p]),
                  u = a.y[x],
                  u = new O(this.ctx).centerTextInBubble(u, s, p).y;
              else
                void 0 !== b && (v = y(b));
          ...
          if (!(Array.isArray(e.config.dataLabels.enabledOnSeries) && e.config.dataLabels.enabledOnSeries.indexOf(r) < 0)) {
            ...
            p && (f = this.dataLabelsCorrection(a, s, n, r, o, u, parseInt(d.style.fontSize, 10))),
              e.globals.zoomed || (a = f.x,
                s = f.y),
              f.textRects && (a < -20 - f.textRects.width || a > e.globals.gridWidth + f.textRects.width + 30) && (n = "");
        ...
        value: function (t) {
          ...
          if (e.xaxis.categories.length > 0)
            ...
            if (i.labels = i.labels[0],
              ...
              new E(e).convertCatToNumericXaxis(e, this.ctx, i.seriesX[0]),
        ...
        value: function (t) {
          ...
          this.coreUtils.getSeriesTotals(),
            a.axisCharts && (a.stackedSeriesTotals = this.coreUtils.getStackedSeriesTotals(),
              a.stackedSeriesTotalsByGroups = this.coreUtils.getStackedSeriesTotalsByGroups()),
      ...
      return r(t, [{
        ...
        value: function (t) {
          ...
          var h, c, d = [], g = [], p = "", f = l.globals.series.map((function (t, e) {
              ...
              if ("category" === l.config.xaxis.type || l.config.xaxis.convertedCatToNumeric)
                if (l.globals.isBarHorizontal) {
                  var a = l.globals.yLabelFormatters[0]
                    , s = new W(e.ctx).getActiveConfigSeriesIndex();
            ...
            if (d.length && 0 === e && g.push(d.join(r)),
              t.data) {
              ...
              for (var a = 0; a < t.data.length; a++) {
                d = [];
                var s = w(a);
                if (s || (m.isFormatXY() ? s = i[e].data[a].x : m.isFormat2DArray() && (s = i[e].data[a] ? i[e].data[a][0] : "")),
                  0 === e) {
                ...
                ("candlestick" === l.config.chart.type || t.type && "candlestick" === t.type) && (d.pop(),
                  d.push(l.globals.seriesCandleO[e][a]),
                  d.push(l.globals.seriesCandleH[e][a]),
                  d.push(l.globals.seriesCandleL[e][a]),
                  d.push(l.globals.seriesCandleC[e][a])),
                  ("boxPlot" === l.config.chart.type || t.type && "boxPlot" === t.type) && (d.pop(),
                    d.push(l.globals.seriesCandleO[e][a]),
                    d.push(l.globals.seriesCandleH[e][a]),
                    d.push(l.globals.seriesCandleM[e][a]),
                    d.push(l.globals.seriesCandleL[e][a]),
                    d.push(l.globals.seriesCandleC[e][a])),
                  "rangeBar" === l.config.chart.type && (d.pop(),
                    d.push(l.globals.seriesRangeStart[e][a]),
                    d.push(l.globals.seriesRangeEnd[e][a])),
                  d.length && g.push(d.join(r))
              }
            }
          };
          d.push(l.config.chart.toolbar.export.csv.headerCategory),
            "boxPlot" === l.config.chart.type ? (d.push("minimum"),
              ...
              d.push("maximum")) : "candlestick" === l.config.chart.type ? (d.push("open"),
                ...
                d.push("close")) : "rangeBar" === l.config.chart.type ? (d.push("minimum"),
                  d.push("maximum")) : i.map((function (t, e) {
            ...
            l.globals.axisCharts || (d.push(l.config.chart.toolbar.export.csv.headerValue),
              g.push(d.join(r))),
            l.globals.allSeriesHasEqualX || !l.globals.axisCharts || l.config.xaxis.categories.length || l.config.labels.length ? i.map((function (t, e) {
              l.globals.axisCharts ? k(t, e) : ((d = []).push(l.globals.labels[e].split(r).join("")),
                d.push(f[e]),
                g.push(d.join(r)))
            }
            )) : (h = new Set,
              ...
              d.length && g.push(d.join(r)),
              Array.from(h).sort().forEach((function (t) {
            ...
            p += g.join(n),
            this.triggerDownload("data:text/csv; charset=utf-8," + encodeURIComponent("\ufeff" + p), a || l.config.chart.toolbar.export.csv.filename, ".csv")
        }
      }, {
        key: "triggerDownload",
        value: function (t, e, i) {
      ...
      return r(t, [{
        ...
        value: function () {
          ...
          ("bar" === r || "rangeBar" === r || "candlestick" === r || "boxPlot" === r || t.globals.comboBarCount > 0) && t.globals.isXNumeric && !t.globals.isBarHorizontal && (o = t.config.grid.padding.left,
            ...
            e.dom.elGridRect = i.drawRect(-a / 2 - o - 2, -a / 2 - 2, e.gridWidth + a + n + o + 4, e.gridHeight + a + 4, 0, "#fff");
        ...
        value: function () {
          ...
          for (var i = 0; i < t.globals.seriesYAxisMap.length && -1 !== t.globals.ignoreYAxisIndexes.indexOf(i);)
            i++;
          ...
          if (!t.globals.isBarHorizontal || this.isRangeBar) {
            var r, o, n;
            if (a = this.xaxisLabels.length,
              this.isRangeBar)
              a--,
                s = t.globals.labels.length,
                t.config.xaxis.tickAmount && t.config.xaxis.labels.formatter && (a = t.config.xaxis.tickAmount),
                (null === (r = t.globals.yAxisScale) || void 0 === r || null === (o = r[i]) || void 0 === o || null === (n = o.result) || void 0 === n ? void 0 : n.length) > 0 && "datetime" !== t.config.xaxis.type && (a = t.globals.yAxisScale[i].result.length - 1);
            this._drawXYLines({
              xCount: a,
              tickAmount: s
            })
    ...
    , _ = function () {
      ...
      return r(t, [{
        ...
        value: function (t, e) {
          ...
          h.isBarHorizontal ? (i = l.config.xaxis,
            a = Math.max((h.svgWidth - 100) / 25, 2)) : (i = l.config.yaxis[o],
          ...
          var c = void 0 !== i.stepSize && null !== i.stepSize
            ...
            , g = d ? i.tickAmount : i.forceNiceScale ? h.niceScaleDefaultTicks[Math.min(Math.round(a / 2), h.niceScaleDefaultTicks.length - 1)] : 10;
          if (h.isMultipleYAxis && !d && h.multiAxisTickAmount > 0 && (g = h.multiAxisTickAmount,
            d = !0),
            g = "dataPoints" === g ? h.dataPoints - 1 : Math.abs(Math.round(g)),
            (t === Number.MIN_VALUE && 0 === e || !x.isNumber(t) && !x.isNumber(e) || t === Number.MIN_VALUE && e === -Number.MAX_VALUE) && (t = 0,
              e = g,
          ...
          var v = b / f
            ...
            , w = Math.pow(10, y)
            , k = Math.ceil(m / w);
          if (v = m = (k = h.niceScaleAllowedMagMsd[0 === h.yValueDecimal ? 0 : 1][k]) * w,
            h.isBarHorizontal && i.stepSize && "datetime" !== i.type ? (v = i.stepSize,
              c = !0) : c && (v = i.stepSize),
            c && i.forceNiceScale) {
            ...
            if (s || r)
              if (r)
                if (d)
                  ...
                  var P = t;
                  t = v * Math.floor(t / v),
                    Math.abs(e - t) / x.getGCD(b, v) > a && (t = e - v * g,
                      t += v * Math.floor((P - t) / v))
                }
              else
                s && (e = d ? t + v * f : v * Math.ceil(e / v));
            else if (d) {
              var M = v / (e - t > e ? 1 : 2)
                , I = M * Math.floor(t / M);
          ...
          if (d || s || r || (f = Math.ceil((b - n) / (v + n))) > 16 && x.getPrimeFactors(f).length < 2 && f++,
            !d && i.forceNiceScale && 0 === h.yValueDecimal && f > b && (f = b,
              v = Math.round(b / f)),
            h.isMultipleYAxis && 0 == h.multiAxisTickAmount && (h.multiAxisTickAmount = f),
            f > a && (!d && !c || i.forceNiceScale)) {
            var T = x.getPrimeFactors(f)
              , z = T.length - 1
              , X = f;
            t: for (var E = 0; E < z; E++)
              for (var Y = 0; Y <= z - E; Y++) {
                for (var F = Math.min(Y + E, z), R = X, H = 1, D = Y; D <= F; D++)
                  H *= T[D];
                if ((R /= H) < a) {
                  X = R;
                  break t
        ...
        value: function (t, e) {
          var i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : 10
            ...
            , r = Math.abs(e - t);
          "dataPoints" === (i = this._adjustTicksForSmallRange(i, a, r)) && (i = this.w.globals.dataPoints - 1),
            s || (s = r / i),
            i === Number.MAX_VALUE && (i = 5,
              s = 1);
          for (var o = [], n = t; i >= 0;)
            o.push(n),
              n += s,
        ...
        value: function (t, e, i) {
          ...
          r.logarithmic && o <= 5 && (a.invalidLogScale = !0),
            r.logarithmic && o > 5 ? (a.allSeriesCollapsed = !1,
              a.yAxisScale[t] = r.forceNiceScale ? this.logarithmicScaleNice(e, i, r.logBase) : this.logarithmicScale(e, i, r.logBase)) : i !== -Number.MAX_VALUE && x.isNumber(i) ? (a.allSeriesCollapsed = !1,
                a.yAxisScale[t] = this.niceScale(e, i, t)) : a.yAxisScale[t] = this.linearScale(0, 10, 10, t, s.yaxis[t].stepSize)
        }
      }, {
        key: "setXScale",
        value: function (t, e) {
          var i = this.w
            , a = i.globals
            , s = Math.abs(e - t);
          return e !== -Number.MAX_VALUE && x.isNumber(e) ? a.xAxisScale = this.linearScale(t, e, i.config.xaxis.tickAmount ? i.config.xaxis.tickAmount : s < 10 && s > 1 ? s + 1 : 10, 0, i.config.xaxis.stepSize) : a.xAxisScale = this.linearScale(0, 10, 10),
            a.xAxisScale
        }
      }, {
        ...
        value: function () {
          var t = this.w.globals
            ...
            , r = []
            , o = []
            , n = e.yaxis.length !== e.series.length;
          ...
          e.yaxis.forEach((function (t, i) {
            ...
            if (t.seriesName) {
              var r = [];
              Array.isArray(t.seriesName) ? r = t.seriesName : r.push(t.seriesName),
                r.forEach((function (t) {
                  e.series.forEach((function (e, r) {
                    if (e.name === t) {
                      i === r || n ? s[i].push(r) : s[r].push(i),
                        a = !0;
                      var l = o.indexOf(r);
                      -1 !== l && o.splice(l, 1)
                    }
            ...
            if (i.length > 0) {
              ...
              if (s.chart.stacked) {
                for (var h = r.seriesX[i[0]].map((function (t) {
                  ...
                  var p = i[u];
                  if (-1 === r.collapsedSeriesIndices.indexOf(p))
                    for (var f = 0; f < r.series[p].length; f++) {
                      var x = r.series[p][f];
                      x >= 0 ? c[f] += x : d[f] += x,
                        h[f] += x
                    }
                }
                "bar" === g ? (n = Math.min.apply(null, d),
                  l = Math.max.apply(null, c)) : (n = Math.min.apply(null, h),
                    l = Math.max.apply(null, h))
              } else {
              ...
              void 0 !== s.yaxis[o].min && (n = "function" == typeof s.yaxis[o].min ? s.yaxis[o].min(n) : s.yaxis[o].min),
                void 0 !== s.yaxis[o].max && (l = "function" == typeof s.yaxis[o].max ? s.yaxis[o].max(l) : s.yaxis[o].max),
                a.setYScaleForIndex(o, n, l),
                i.forEach((function (i) {
                  t[i] = r.yAxisScale[o].niceMin,
                    e[i] = r.yAxisScale[o].niceMax
                }
                ))
            }
          }
      ...
      return r(t, [{
        ...
        value: function (t) {
          ...
          if (r.seriesX.length >= a) {
            var d, g;
            l = 0,
              h = (c = u(new Set((d = []).concat.apply(d, u(r.seriesX.slice(t, a)))))).length - 1;
          ...
          var f = r.series
            , b = f
            , v = f;
          "candlestick" === s.chart.type ? (b = r.seriesCandleL,
            v = r.seriesCandleH) : "boxPlot" === s.chart.type ? (b = r.seriesCandleO,
              v = r.seriesCandleC) : r.isRangeData && (b = r.seriesRangeStart,
                v = r.seriesRangeEnd);
          for (var m = t; m < a; m++) {
            ...
            for (var w = l; w <= h && w < r.series[m].length; w++) {
              ...
              if (null !== k && x.isNumber(k)) {
                switch (void 0 !== v[m][w] && (o = Math.max(o, v[m][w]),
                  e = Math.min(e, v[m][w])),
                void 0 !== b[m][w] && (e = Math.min(e, b[m][w]),
                  i = Math.max(i, b[m][w])),
                y) {
                  case "candlestick":
                    void 0 !== r.seriesCandleC[m][w] && (o = Math.max(o, r.seriesCandleH[m][w]),
                      e = Math.min(e, r.seriesCandleL[m][w]));
                  case "boxPlot":
                    void 0 !== r.seriesCandleC[m][w] && (o = Math.max(o, r.seriesCandleC[m][w]),
                      e = Math.min(e, r.seriesCandleO[m][w]))
                }
                y && "candlestick" !== y && "boxPlot" !== y && "rangeArea" !== y && "rangeBar" !== y && (o = Math.max(o, r.series[m][w]),
                  e = Math.min(e, r.series[m][w])),
                  i = o,
                  r.seriesGoals[m] && r.seriesGoals[m][w] && Array.isArray(r.seriesGoals[m][w]) && r.seriesGoals[m][w].forEach((function (t) {
                  ...
                  x.isFloat(k) && (k = x.noExponents(k),
                    r.yValueDecimal = Math.max(r.yValueDecimal, k.toString().split(".")[1].length)),
                  n > b[m][w] && b[m][w] < 0 && (n = b[m][w])
              } else
                r.hasNullValues = !0
            }
            "bar" !== y && "column" !== y || (n < 0 && o < 0 && (o = 0,
              i = Math.max(i, 0)),
        ...
        value: function () {
          ...
          if (i = this.getMinYMaxY(0, a, null, t.series.length),
            "bar" === e.chart.type ? (t.minY = i.minY,
              t.maxY = i.maxY) : (t.minY = i.lowestY,
                t.maxY = i.highestY),
            a = i.lowestY,
            e.chart.stacked && this._setStackedMinMax(),
            "line" === e.chart.type || "area" === e.chart.type || "scatter" === e.chart.type || "candlestick" === e.chart.type || "boxPlot" === e.chart.type || "rangeBar" === e.chart.type && !t.isBarHorizontal ? t.minY === Number.MIN_VALUE && a !== -Number.MAX_VALUE && a !== t.maxY && (t.minY = a) : t.minY = i.minY,
          ...
          return t.isMultipleYAxis ? (this.scales.setMultipleYScales(),
            t.minY = a) : (this.scales.setYScaleForIndex(0, t.minY, t.maxY),
              ...
              t.seriesYAxisMap = [t.series.map((function (t, e) {
                return e
              }
              ))],
        ...
        value: function () {
          ...
          if (t.isXNumeric && function () {
            ...
            if (void 0 === e.xaxis.tickAmount ? (a = Math.round(t.svgWidth / 150),
              ...
              t.xAxisScale = this.scales.linearScale(0, a, a, 0, e.xaxis.stepSize),
                t.noLabelsProvided && t.labels.length > 0 && (t.xAxisScale = this.scales.linearScale(1, t.labels.length, a - 1, 0, e.xaxis.stepSize),
        ...
        value: function (t) {
          ...
          if (e.globals.comboBarCount > 0 && (r = e.globals.comboBarCount),
            ...
            l <= 3 && (l = e.globals.dataPoints),
              ...
              n > t / 2 && (n /= 2),
              (s = n * parseInt(e.config.plotOptions.bar.columnWidth, 10) / 100) < 1 && (s = 1),
        ...
        value: function () {
          ...
          this.lgRect = this.dimHelpers.getLegendsRect(),
            this.isSparkline && ((e.config.markers.discrete.length > 0 || e.config.markers.size > 0) && Object.entries(this.gridPad).forEach((function (e) {
              ...
              this.gridPad.top = Math.max(e.config.stroke.width / 2, this.gridPad.top),
              this.gridPad.bottom = Math.max(e.config.stroke.width / 2, this.gridPad.bottom)),
      ...
      return r(t, [{
        ...
        value: function () {
          ...
          for (var o = e.globals.legendFormatter, n = e.config.legend.inverseOrder, l = n ? a.length - 1 : 0; n ? l >= 0 : l <= a.length - 1; n ? l-- : l++) {
            ...
            M.classList.add("apexcharts-legend-text"),
              M.innerHTML = Array.isArray(c) ? c.join(" ") : c;
            ...
            I || (I = e.config.chart.foreColor),
              M.style.color = I,
              M.style.fontSize = parseFloat(e.config.legend.fontSize) + "px",
              M.style.fontWeight = e.config.legend.fontWeight,
              M.style.fontFamily = i || e.config.chart.fontFamily,
              m.setAttrs(M, {
                rel: l + 1,
                i: l,
            ...
            e.config.legend.showForNullSeries || T.isSeriesNull(l) && -1 === e.globals.collapsedSeriesIndices.indexOf(l) && -1 === e.globals.ancillaryCollapsedSeriesIndices.indexOf(l) && P.classList.add("apexcharts-hidden-null-series"),
        ...
        value: function (t) {
          ...
          if ("heatmap" === e.config.chart.type || this.isBarsDistributed) {
            ...
            !t.target.classList.contains("apexcharts-inactive-legend") && i && new W(this.ctx).toggleSeriesOnHover(t, t.target)
        }
      }, {
        key: "onLegendClick",
        value: function (t) {
      ...
      return r(i, [{
          ...
          if (e.shiftKey ? (this.shiftWasPressed = !0,
            ...
            if (e.target.parentNode && null !== e.target.parentNode && (n = e.target.parentNode.classList),
              ...
              if (a.clientX = "touchmove" === e.type || "touchstart" === e.type ? e.touches[0].clientX : "touchend" === e.type ? e.changedTouches[0].clientX : e.clientX,
                ...
                ("mousedown" === e.type || "touchmove" === e.type) && 1 === e.which) {
              ...
              if ("mousemove" === e.type && 1 === e.which || "touchmove" === e.type)
                if (a.dragged = !0,
                  i.globals.panEnabled) {
                  if (i.globals.selection = null,
                    a.w.globals.mousedown || "touchmove" === e.type) {
                  ...
                  if ("touchmove" === e.type) {
                    if (!a.w.globals.mousedown) {
                      ...
                      a.startX = a.clientX - d.left,
                        a.startY = a.clientY - d.top
                    }
                    a.w.globals.mousedown = !0
                  }
              ...
              if ("mouseup" === e.type || "touchend" === e.type || "mouseleave" === e.type) {
                ...
                a.w.globals.mousedown && (a.endX = a.clientX - g.left,
                  a.endY = a.clientY - g.top,
        ...
        value: function () {
          ...
          if (!t.globals.zoomEnabled)
            if (void 0 !== t.globals.selection && null !== t.globals.selection)
              ...
              t.globals.isRangeBar && (i = (t.config.chart.selection.xaxis.min - t.globals.yAxisScale[0].niceMin) / e.invertedYRatio,
                a = (t.config.chart.selection.xaxis.max - t.config.chart.selection.xaxis.min) / e.invertedYRatio);
              var s = {
                x: i,
                y: 0,
                width: a,
          ...
          a.globals.selection = l,
            "function" == typeof a.config.chart.events.selection && a.globals.selectionEnabled && (clearTimeout(this.w.globals.selectionResizeTimer),
              this.w.globals.selectionResizeTimer = window.setTimeout((function () {
                ...
                a.globals.isRangeBar ? (t = a.globals.yAxisScale[0].niceMin + (h.left - l.left) * s.invertedYRatio,
                  e = a.globals.yAxisScale[0].niceMin + (h.right - l.left) * s.invertedYRatio,
                  o = 0,
                  n = 1) : (t = a.globals.xAxisScale.niceMin + (h.left - l.left) * s.xRatio,
                    e = a.globals.xAxisScale.niceMin + (h.right - l.left) * s.xRatio,
                    o = a.globals.yAxisScale[0].niceMin + (l.bottom - h.bottom) * s.yRatio[0],
                    n = a.globals.yAxisScale[0].niceMax - (h.top - l.top) * s.yRatio[0]);
                var c = {
                  xaxis: {
                    min: t,
                    max: e
                ...
                a.config.chart.events.selection(i.ctx, c),
                  a.config.chart.brush.enabled && void 0 !== a.config.chart.events.brushScrolled && a.config.chart.events.brushScrolled(i.ctx, c)
              }
              ), o))
        }
      }, {
        ...
        value: function (t) {
          ...
          if (a.config.yaxis.forEach((function (t, e) {
            ...
            d.push(a.globals.yAxisScale[e].niceMax - r.yRatio[i] * s.startY),
              g.push(a.globals.yAxisScale[e].niceMax - r.yRatio[i] * s.endY)
          }
          )),
            ...
            if (a.globals.zoomEnabled) {
              ...
              a.config.chart.group || (b.yaxis = u),
                s.ctx.updateHelpers._updateOptions(b, !1, s.w.config.chart.animations.dynamicAnimation.enabled),
        ...
        value: function (t) {
          ...
          if (o && f[0]) {
            if (l.config.tooltip.hideEmptySeries) {
              ...
              0 == parseFloat(c) ? (w.style.display = "none",
    ...
    , ut = function () {
      ...
      return r(t, [{
        ...
        value: function (t) {
          ...
          e = new W(this.ctx).getActiveConfigSeriesIndex("asc", ["line", "area", "scatter", "bubble"]);
        ...
        value: function (t, e, i) {
          ...
          if (a.yaxisTooltips[t]) {
            var o = a.getElGrid().getBoundingClientRect()
              , n = s.globals.seriesYAxisMap[anno.yAxisIndex][0]
              , l = (e - o.top) * i.yRatio[n]
              , h = s.globals.maxYArr[n] - s.globals.minYArr[n]
              , c = s.globals.minYArr[n] + (h - l);
      ...
      return r(t, [{
        ...
        value: function () {
          ...
          if (l.config.plotOptions.bar.rangeBarGroupRows && (c = 1),
            ...
            -1 === String(this.barCtx.barOptions.columnWidth).indexOf("%") && (r = parseInt(this.barCtx.barOptions.columnWidth, 10)),
              o = l.globals.gridHeight - this.barCtx.baseLineY[this.barCtx.translationsIndex] - (this.barCtx.isReversed ? l.globals.gridHeight : 0) + (this.barCtx.isReversed ? 2 * this.barCtx.baseLineY[this.barCtx.translationsIndex] : 0),
              t = l.globals.padHorizontal + (a - r * this.barCtx.seriesLen) / 2
          }
          return l.globals.barHeight = s,
        ...
        value: function (t) {
          var e = t.j
            ...
            , c = new W(this.barCtx.ctx).getActiveConfigSeriesIndex();
        ...
        value: function (t, e, i) {
          ...
          return null != t && (a = e - t / this.barCtx.yRatio[i] + 2 * (this.barCtx.isReversed ? t / this.barCtx.yRatio[i] : 0)),
            a
        }
      }, {
        key: "getGoalValues",
        value: function (t, i, a, s, r, n) {
          var l = this
            ...
            , d = function (e, s) {
              var r;
              c.push((o(r = {}, t, "x" === t ? l.getXForValue(e, i, !1) : l.getYForValue(e, a, n, !1)),
                o(r, "attrs", s),
                r))
            };
          if (h.globals.seriesGoals[s] && h.globals.seriesGoals[s][r] && Array.isArray(h.globals.seriesGoals[s][r]) && h.globals.seriesGoals[s][r].forEach((function (t) {
            ...
            var g = this.barCtx.barOptions.dumbbellColors ? this.barCtx.barOptions.dumbbellColors : h.globals.colors
              , u = {
            ...
            d(h.globals.seriesRangeStart[s][r], u),
              d(h.globals.seriesRangeEnd[s][r], e(e({}, u), {}, {
      ...
      return r(t, [{
        ...
        value: function (t, i) {
          ...
          for (var n = 0, l = 0; n < t.length; n++,
            ...
            var k = 0
              , A = 0;
            this.yRatio.length > 1 && (this.yaxisIndex = a.globals.seriesYAxisReverseMap[v],
        ...
        value: function (t) {
          ...
          var I = s / P.config.chart.animations.animateGradually.delay * (P.config.chart.animations.speed / P.globals.dataPoints) / 2.4
            , T = M.renderPaths({
              i: r,
              j: s,
              realIndex: e,
          ...
          z.count > 0 && s >= P.globals.dataPoints - z.count && (T.node.setAttribute("stroke-dasharray", z.dashArray),
            T.node.setAttribute("stroke-width", z.strokeWidth),
            T.node.setAttribute("fill-opacity", z.fillOpacity)),
            void 0 !== u && void 0 !== p && (T.attr("data-range-y1", u),
              T.attr("data-range-y2", p)),
            new v(this.ctx).setSelectionFilter(T, e, s),
            c.add(T);
        ...
        value: function (t) {
          var e = t.x
            ...
            , r = this.w
            , o = a;
          return r.globals.seriesX[a].length || (o = r.globals.maxValsInArrayIndex),
            r.globals.seriesX[o][s] && (e = (r.globals.seriesX[o][s] - r.globals.minX) / this.xRatio - i * this.seriesLen / 2),
          {
    ...
    , wt = function (t) {
      ...
      return r(s, [{
        ...
        value: function (t, i) {
          ...
          for (var o = this.graphics.group({
            ...
            var f = []
              ...
              , m = 0;
            a.yRatio.length > 1 && (a.yaxisIndex = s.globals.seriesYAxisReverseMap[v][0],
              m = v),
            ...
            var w = a.graphics.group({
              ...
              , A = 0
              , S = 0
              , C = a.initialPositions(n, l, c, d, g, u, m);
            l = C.y,
              A = C.barHeight,
              d = C.yDivision,
              u = C.zeroW,
              ...
              c = C.xDivision,
              g = C.zeroH,
              s.globals.barHeight = A,
              s.globals.barWidth = S,
            ...
            for (var L = 0; L < s.globals.dataPoints; L++) {
              var P = a.barHelpers.getStrokeWidth(r, L, v)
                , M = {
                  indexes: {
                    i: r,
                    j: L,
        ...
        value: function (t, e, i, a, s, r, o) {
          ...
          return this.isHorizontal ? (h = (h = a = d.globals.gridHeight / d.globals.dataPoints) * parseInt(d.config.plotOptions.bar.barHeight, 10) / 100,
            -1 === String(d.config.plotOptions.bar.barHeight).indexOf("%") && (h = parseInt(d.config.plotOptions.bar.barHeight, 10)),
            r = this.baseLineInvertedY + d.globals.padHorizontal + (this.isReversed ? d.globals.gridWidth : 0) - (this.isReversed ? 2 * this.baseLineInvertedY : 0),
            e = (a - h) / 2) : (c = i = d.globals.gridWidth / d.globals.dataPoints,
              c = d.globals.isXNumeric && d.globals.dataPoints > 1 ? (i = d.globals.minXDiff / this.xRatio) * parseInt(this.barOptions.columnWidth, 10) / 100 : c * parseInt(d.config.plotOptions.bar.columnWidth, 10) / 100,
              -1 === String(d.config.plotOptions.bar.columnWidth).indexOf("%") && (c = parseInt(d.config.plotOptions.bar.columnWidth, 10)),
              s = d.globals.gridHeight - this.baseLineY[o] - (this.isReversed ? d.globals.gridHeight : 0) + (this.isReversed ? 2 * this.baseLineY[o] : 0),
              t = d.globals.padHorizontal + (i - c) / 2),
          {
            x: t,
            y: e,
            yDivision: a,
        ...
        value: function (t) {
          for (var e, i = t.indexes, a = t.barHeight, s = t.strokeWidth, r = t.zeroW, o = t.x, n = t.y, l = t.groupIndex, h = t.seriesGroup, c = t.yDivision, d = t.elSeries, g = this.w, u = n + (-1 !== l ? l * a : 0), p = i.i, f = i.j, x = i.translationsIndex, b = 0, v = 0; v < this.groupCtx.prevXF.length; v++)
            b += this.groupCtx.prevXF[v][f];
          var m = p;
          if (h && (m = h.indexOf(g.config.series[p].name)),
            m > 0) {
            var y = r;
            this.groupCtx.prevXVal[m - 1][f] < 0 ? y = this.series[p][f] >= 0 ? this.groupCtx.prevX[m - 1][f] + b - 2 * (this.isReversed ? b : 0) : this.groupCtx.prevX[m - 1][f] : this.groupCtx.prevXVal[m - 1][f] >= 0 && (y = this.series[p][f] >= 0 ? this.groupCtx.prevX[m - 1][f] : this.groupCtx.prevX[m - 1][f] - b + 2 * (this.isReversed ? b : 0)),
              e = y
          } else
            e = r;
        ...
        value: function (t) {
          ...
          if (c.globals.isXNumeric) {
            ...
            f || (f = 0),
              i = (f - c.globals.minX) / this.xRatio - r / 2,
              c.globals.seriesGroups.length && (i = (f - c.globals.minX) / this.xRatio - r / 2 * c.globals.seriesGroups.length)
          }
          for (var x, b = i + (-1 !== n ? n * r : 0), v = 0, m = 0; m < this.groupCtx.prevYF.length; m++)
            v += isNaN(this.groupCtx.prevYF[m][g]) ? 0 : this.groupCtx.prevYF[m][g];
          var y = d;
          if (l && (y = l.indexOf(c.config.series[d].name)),
            y > 0 && !c.globals.isXNumeric || y > 0 && c.globals.isXNumeric && c.globals.seriesX[d - 1][g] === c.globals.seriesX[d][g]) {
            var w, k, A, S = Math.min(this.yRatio.length + 1, d + 1);
            if (void 0 !== this.groupCtx.prevY[y - 1] && this.groupCtx.prevY[y - 1].length)
              for (var C = 1; C < S; C++) {
                var L;
            ...
            void 0 === k && (k = c.globals.gridHeight),
              x = null !== (w = this.groupCtx.prevYF[0]) && void 0 !== w && w.every((function (t) {
                return 0 === t
              }
      ...
      return r(s, [{
        ...
        value: function (t, i, a) {
          ...
          for (var c = o.group({
            ...
            var y, w, k = 0;
            s.yRatio.length > 1 && (s.yaxisIndex = r.globals.seriesYAxisReverseMap[v][0],
              k = v);
        ...
        value: function (t) {
          ...
          var f = this.yRatio[e.translationsIndex]
            , x = e.realIndex
    ...
    , St = function () {
      ...
      return r(t, [{
        ...
        value: function (t) {
          ...
          return e.config.yaxis[0].reversed ? M.unshift("") : M.push(""),
    ...
    , Lt = function () {
      ...
      return r(t, [{
        ...
        value: function (t) {
          ...
          Math.ceil(h) >= this.fullAngle + this.w.config.plotOptions.pie.startAngle % this.fullAngle && (h = this.fullAngle + this.w.config.plotOptions.pie.startAngle % this.fullAngle - .01),
          ...
          return e = "donut" === i.chartType ? [].concat(y, ["L", f.x, f.y, "A", i.donutSize, i.donutSize, 0, v, 0, b.x, b.y, "L", d, g, "z"]).join(" ") : "pie" === i.chartType || "polarArea" === i.chartType ? [].concat(y, ["L", i.centerX, i.centerY, "L", d, g]).join(" ") : [].concat(y).join(" "),
            o.roundPathCorners(e, 2 * this.strokeWidth)
        }
      }, {
    ...
    , Pt = function () {
      function t(e) {
        ...
        this.graphics = new m(this.ctx),
          ...
          this.logBase = i.config.yaxis[0].logBase,
          this.coreUtils = new y(this.ctx),
          this.maxValue = this.isLog ? this.coreUtils.getLogVal(this.logBase, i.globals.maxY, 0) : i.globals.maxY,
          this.minValue = this.isLog ? this.coreUtils.getLogVal(this.logBase, this.w.globals.minY, 0) : i.globals.minY,
              ...
              i.dataRadiusOfPercent[n] = [],
                ...
                t.forEach((function (t, e) {
                  ...
                  t += Math.abs(i.minValue),
                    i.isLog && (t = i.coreUtils.getLogVal(i.logBase, t, 0)),
    ...
    , Mt = function (t) {
      ...
      function i(t) {
        ...
        return s.startAngle = r.config.plotOptions.radialBar.startAngle,
          ...
          s.onBarLabelClick = s.onBarLabelClick.bind(c(s)),
          s
      }
      return r(i, [{
        key: "draw",
        ...
        value: function (t) {
          ...
          for (var f = p ? t.series.length - 1 : 0; p ? f >= 0 : f < t.series.length; p ? f-- : f++) {
            ...
            if (s.setSelectionFilter(M, 0, f),
              ...
              var T = x.polarToCartesian(t.centerX, t.centerY, t.size, w)
              ...
              var Y = T.x - this.barLabels.margin
                , F = T.y
                , R = i.drawText({
                  x: Y,
                  y: F,
            ...
            var D = 0;
            !this.initialAnim || e.globals.resized || e.globals.dataChanged || (D = e.config.chart.animations.speed),
              e.globals.dataChanged && (D = e.config.chart.animations.dynamicAnimation.speed),
              this.animDur = D / (1.2 * t.series.length) + this.animDur,
              this.animBeginArr.push(this.animDur),
              this.animatePaths(M, {
                centerX: t.centerX,
                centerY: t.centerY,
      ...
      return r(s, [{
        ...
        value: function (t, i) {
          ...
          for (var r = s.group({
            ...
            var b = 0
              , v = 0
              , y = 0;
            this.yRatio.length > 1 && (this.yaxisIndex = a.globals.seriesYAxisReverseMap[p][0],
              y = p);
            ...
            for (var k = s.group({
              ...
              if (a.config.plotOptions.bar.rangeBarGroupRows && (E = 1),
                void 0 === a.config.series[n].data[S])
                break;
              if (this.isHorizontal) {
                ...
                a.globals.isXNumeric && (g = (a.globals.seriesX[n][S] - a.globals.minX) / this.xRatio - v / 2),
                  T = g + v * this.visibleI;
                var R = (l - v * E) / 2;
                if (a.config.series[n].data[S].x) {
              ...
              D && A.add(D),
                u = I.y,
                g = I.x;
              var O = this.barHelpers.getPathFillColor(t, n, S, p)
                , N = a.globals.stroke.colors[p];
              this.renderSeries((o(C = {
                ...
                o(C, "elDataLabelsWrap", k),
                o(C, "elGoalsMarkers", A),
                o(C, "visibleSeries", this.visibleI),
                o(C, "type", "rangebar"),
                C))
            }
            r.add(f)
        ...
        value: function (t) {
          var e = t.indexes
            ...
            , l = e.i
            , h = e.j
            , c = this.yRatio[e.translationsIndex]
            , d = e.realIndex
      ...
      return r(t, [{
        ...
        value: function (t) {
          ...
          if (void 0 !== (null === (i = s[a]) || void 0 === i ? void 0 : i[0]))
            r = (o = h && a > 0 ? this.lineCtx.prevSeriesY[a - 1][0] : this.lineCtx.zeroY) - s[a][0] / this.lineCtx.yRatio[n] + 2 * (this.lineCtx.isReversed ? s[a][0] / this.lineCtx.yRatio[n] : 0);
          else if (h && a > 0 && void 0 === s[a][0])
            for (var c = a - 1; c >= 0; c--)
              if (null !== s[c][0] && void 0 !== s[c][0]) {
  ...
  var Ft = function () {
    ...
    return r(t, [{
      ...
      value: function (t, i, a, s) {
        ...
        for (var d = [], g = 0; g < t.length; g++) {
          ...
          this.ctx.series.addCollapsedClassToSeries(this.elSeries, u),
            o.globals.isXNumeric && o.globals.seriesX.length > 0 && (v = (o.globals.seriesX[u][0] - o.globals.minX) / this.xRatio),
            b.push(v);
          ...
          C = this.lineHelpers.determineFirstPrevY({
            ...
            "monotonCubic" === o.config.stroke.curve && null === t[g][0] ? f.push(null) : f.push(C),
            w = C;
          ...
          if ("rangeArea" === l) {
            ...
            M.linePaths[0] = T.linePath + M.linePath,
              M.pathFromLine = T.pathFromLine + M.pathFromLine
          }
          this._handlePaths({
            type: l,
            realIndex: u,
      ...
      value: function (t, e, i) {
        ...
        var r = 0;
        this.yRatio.length > 1 && (this.yaxisIndex = a.globals.seriesYAxisReverseMap[i],
          r = i),
          this.isReversed = a.config.yaxis[this.yaxisIndex] && a.config.yaxis[this.yaxisIndex].reversed,
          this.zeroY = a.globals.gridHeight - this.baseLineY[r] - (this.isReversed ? a.globals.gridHeight : 0) + (this.isReversed ? 2 * this.baseLineY[r] : 0),
      ...
      value: function (t) {
        ...
        if (null === o[n][0]) {
          for (var p = 0; p < o[n].length; p++)
            if (null !== o[n][p]) {
              h = this.xDivision * p,
                c = this.zeroY - o[n][p] / this.yRatio[l],
                e = u.move(h, c),
      ...
      value: function (t) {
        ...
        for (var Y = function (t, e) {
          ...
          if (C.globals.isXNumeric) {
            ...
            void 0 === C.globals.seriesX[o][H + 1] && (O = C.globals.seriesX[o][r - 1]),
              h = (O - C.globals.minX) / this.xRatio
          } else
            h += this.xDivision;
          if (R)
            if (l > 0 && C.globals.collapsedSeries.length < C.config.series.length - 1) {
              v = this.prevSeriesY[function (t) {
                for (var e = t, i = 0; i < C.globals.series.length; i++)
                  if (C.globals.collapsedSeriesIndices.indexOf(t) > -1) {
                    e--;
                    break
                  }
                return e >= 0 ? e : 0
            ...
            v = this.zeroY;
          D ? c = Y(E, v) : (c = Y(s[l][H + 1], v),
            "rangeArea" === a && (F = Y(S[l][H + 1], v))),
            y.push(h),
            D && "smooth" === C.config.stroke.curve ? w.push(null) : w.push(c),
            k.push(F);
          ...
          f = W.areaPaths,
            ...
            T = W.areaPath,
            I = W.linePath,
            !this.appendPathFrom || "monotoneCubic" === C.config.stroke.curve && "rangeArea" === a || (z += L.line(h, this.zeroY),
              X += L.line(h, this.zeroY)),
            this.handleNullDataPoints(s, N, l, H, o),
      ...
      value: function (t) {
        var e = t.type
          ...
          , S = this.areaBottomY;
        if (Array.isArray(w.config.stroke.curve) && (A = Array.isArray(v) ? w.config.stroke.curve[v[a]] : w.config.stroke.curve[a]),
          "rangeArea" === e && (w.globals.hasNullValues || w.config.forecastDataPoints.count > 0) && "monotoneCubic" === A && (A = "straight"),
          "monotoneCubic" === A) {
          var C = "rangeArea" === e ? l.length === w.globals.dataPoints : r === i[a].length - 2
          ...
          if (C && L.length > 1) {
            var P = Et(L);
            if (p += Xt(P),
              null === i[a][0] ? f = p : f += Xt(P),
              "rangeArea" === e && y) {
              p += k.line(l[l.length - 1], d[d.length - 1]);
              var M = l.slice().reverse()
                , I = d.slice().reverse()
                , T = M.map((function (t, e) {
                  return [M[e], I[e]]
                }
                ))
                , z = Et(T);
          ...
          var X = .35 * (o - g);
          w.globals.hasNullValues ? (null !== i[a][r] && (null !== i[a][r + 1] ? (p = k.move(g, u) + k.curve(g + X, u, o - X, n, o + 1, n),
            f = k.move(g + 1, u) + k.curve(g + X, u, o - X, n, o + 1, n) + k.line(o, S) + k.line(g, S) + "z") : (p = k.move(g, u),
              f = k.move(g, u) + "z")),
            x.push(p),
            b.push(f)) : (p += k.curve(g + X, u, o - X, n, o, n),
              f += k.curve(g + X, u, o - X, n, o, n)),
            g = o,
            u = n,
            r === i[a].length - 2 && (f = f + k.curve(g, u, o, n, o, S) + k.move(o, n) + "z",
              "rangeArea" === e && y ? p = p + k.curve(g, u, o, n, o, c) + k.move(o, c) + "z" : w.globals.hasNullValues || (x.push(p),
                b.push(f)))
        } else {
          if (null === i[a][r + 1]) {
            p += k.move(o, n);
          ...
          null === i[a][r] && (p += k.move(o, n),
            f += k.move(o, S)),
            "stepline" === A ? (p = p + k.line(o, null, "H") + k.line(null, n, "V"),
              f = f + k.line(o, null, "H") + k.line(null, n, "V")) : "linestep" === A ? (p = p + k.line(null, n, "V") + k.line(o, null, "H"),
                f = f + k.line(null, n, "V") + k.line(o, null, "H")) : "straight" === A && (p += k.line(o, n),
                  f += k.line(o, n)),
            r === i[a].length - 2 && (f = f + k.line(o, S) + k.move(o, n) + "z",
              "rangeArea" === e && y ? p = p + k.line(o, c) + k.move(o, c) + "z" : (x.push(p),
                b.push(f)))
        }
        return {
          linePaths: x,
          ...
          window.TreemapSquared.generate(o, i.globals.gridWidth, i.globals.gridHeight).forEach((function (o, n) {
            ...
            o.forEach((function (r, o) {
              var h = r[0]
                ...
                , d = r[2]
                , g = r[3]
                , u = a.drawRect(h, c, d - h, g - c, i.config.plotOptions.treemap.borderRadius, "#fff", 1, e.strokeWidth, i.config.plotOptions.treemap.useFillColorAsStroke ? f : i.globals.stroke.colors[n]);
              u.attr({
                cx: h,
                cy: c,
                index: n,
    ...
    return r(t, [{
      ...
      value: function () {
        ...
        t.axisCharts = ["line", "area", "bar", "rangeBar", "rangeArea", "candlestick", "boxPlot", "scatter", "bubble", "radar", "heatmap", "treemap"].indexOf(i) > -1,
          ...
          t.dom.Paper.node.style.background = "dark" !== e.theme.mode || e.chart.background ? e.chart.background : "rgba(0, 0, 0, 0.8)",
      ...
      value: function (t, e) {
        var i = this.w
          ...
          , p = void 0 !== a.chart.type ? a.chart.type : "line"
          , f = 0;
        s.series.map((function (e, x) {
          void 0 !== t[x].type ? "column" === t[x].type || "bar" === t[x].type ? (s.series.length > 1 && a.plotOptions.bar.horizontal && console.warn("Horizontal bars are not supported in a mixed/combo chart. Please turn off `plotOptions.bar.horizontal`"),
            h.series.push(e),
            h.i.push(x),
            "bar" !== p && f++,
            i.globals.columnSeries = h.series) : "area" === t[x].type ? (o.series.push(e),
              o.i.push(x),
              p !== t[x].type && f++) : "line" === t[x].type ? (r.series.push(e),
                r.i.push(x),
                p !== t[x].type && f++) : "scatter" === t[x].type ? (n.series.push(e),
                  n.i.push(x)) : "bubble" === t[x].type ? (l.series.push(e),
                    l.i.push(x),
                    p !== t[x].type && f++) : "candlestick" === t[x].type ? (c.series.push(e),
                      c.i.push(x),
                      p !== t[x].type && f++) : "boxPlot" === t[x].type ? (d.series.push(e),
                        d.i.push(x),
                        p !== t[x].type && f++) : "rangeBar" === t[x].type ? (g.series.push(e),
                          g.i.push(x),
                          p !== t[x].type && f++) : "rangeArea" === t[x].type ? (u.series.push(s.seriesRangeStart[x]),
                            u.seriesRangeEnd.push(s.seriesRangeEnd[x]),
                            u.i.push(x),
                            p !== t[x].type && f++) : console.warn("You have specified an unrecognized chart type. Available types for this property are line/area/column/bar/scatter/bubble/candlestick/boxPlot/rangeBar/rangeArea") : (r.series.push(e),
                              r.i.push(x))
        }
        )),
          s.comboCharts || (s.comboCharts = f > 0);
        var x = new Ft(this.ctx, e)
          , b = new kt(this.ctx, e);
        this.ctx.pie = new Lt(this.ctx);
        var v = new Mt(this.ctx);
        this.ctx.rangeBar = new It(this.ctx, e);
        var m = new Pt(this.ctx)
          , y = [];
        if (s.comboCharts) {
          if (o.series.length > 0 && y.push(x.draw(o.series, "area", o.i)),
            h.series.length > 0)
            if (i.config.chart.stacked) {
              ...
              this.ctx.bar = new yt(this.ctx, e),
                y.push(this.ctx.bar.draw(h.series, h.i));
          if (u.series.length > 0 && y.push(x.draw(u.series, "rangeArea", u.i, u.seriesRangeEnd)),
            r.series.length > 0 && y.push(x.draw(r.series, "line", r.i)),
            c.series.length > 0 && y.push(b.draw(c.series, "candlestick", c.i)),
            d.series.length > 0 && y.push(b.draw(d.series, "boxPlot", d.i)),
            g.series.length > 0 && y.push(this.ctx.rangeBar.draw(g.series, g.i)),
            n.series.length > 0) {
          ...
          switch (a.chart.type) {
            ...
            case "bar":
              if (a.chart.stacked)
                y = new wt(this.ctx, e).draw(s.series);
              else
                this.ctx.bar = new yt(this.ctx, e),
                  y = this.ctx.bar.draw(s.series);
              break;
            case "candlestick":
        ...
        switch (t[0]) {
          ...
          case "A":
            e = function (t, e) {
              ...
              if (0 === M || 0 === I || F.x === R.x && F.y === R.y)
                return [["C", F.x, F.y, R.x, R.y, R.x, R.y]];
              i = new SVG.Point((F.x - R.x) / 2, (F.y - R.y) / 2).transform((new SVG.Matrix).rotate(T)),
                (a = i.x * i.x / (M * M) + i.y * i.y / (I * I)) > 1 && (M *= a = Math.sqrt(a),
                  I *= a);
              s = (new SVG.Matrix).rotate(T).scale(1 / M, 1 / I).rotate(-T),
                F = F.transform(s),
                R = R.transform(s),
                r = [R.x - F.x, R.y - F.y],
                n = r[0] * r[0] + r[1] * r[1],
              ...
              for (b[0][0] = b[0][1].clone(),
                ...
                s = (new SVG.Matrix).rotate(T).scale(M, I).rotate(-T),
                k = 0,
                A = b.length; k < A; k++)
    ...
    return r(t, [{
      ...
      value: function () {
        this.ctx.publicMethods = ["updateOptions", "updateSeries", "appendData", "appendSeries", "isSeriesHidden", "toggleSeries", "showSeries", "hideSeries", "setLocale", "resetSeries", "zoomX", "toggleDataPointSelection", "dataURI", "exportToCSV", "addXaxisAnnotation", "addYaxisAnnotation", "addPointAnnotation", "clearAnnotations", "removeAnnotation", "paper", "destroy"],
          ...
          this.ctx.formatters = new S(this.ctx),
    ...
    return r(t, [{
      ...
      value: function (t, e) {
        ...
        (a.noData = !1,
          ...
          i.config.xaxis.convertedCatToNumeric) && new E(i.config).convertCatToNumericXaxis(i.config, this.ctx);
        if (null === this.el)
